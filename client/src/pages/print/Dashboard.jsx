...
import { EmptyState, Pill, StatCard } from '../../components/print/ui';
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <div className="card !p-4">
          <div className="flex items-center justify-between mb-3">
            ...
            <Link to="/print/orders" className="btn-ghost !py-1 !px-2 text-xs">All orders</Link>
          </div>
        ...
        <div className="card !p-4">
          <div className="flex items-center justify-between mb-3">
            ...
            <Link to="/print/queue" className="btn-ghost !py-1 !px-2 text-xs">Full queue</Link>
          </div>
        ...
        <div className="card !p-4 lg:col-span-2">
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="flex gap-1">
              <Link to="/print/filament" className="btn-ghost !py-1 !px-2 text-xs">Filament</Link>
              <Link to="/print/materials" className="btn-ghost !py-1 !px-2 text-xs">Materials</Link>
            </div>
          </div>
      ...
      {!inventory.counts.filaments && !inventory.counts.products && (
        <EmptyState
          title="Start here"
          action={<Link to="/print/filament" className="btn-primary">Add your filament</Link>}
        >
