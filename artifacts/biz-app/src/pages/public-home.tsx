        ...
        <div className="max-w-6xl mx-auto px-5 sm:px-8 py-20 md:py-28 relative">
          <div className="flex flex-col md:flex-row items-center gap-12 md:gap-16">
            ...
            <div className="flex-1">
              ...
              <h1 className="text-[2.7rem] md:text-[3.4rem] lg:text-[2.8rem] font-bold text-black leading-tight mb-6">
                Taking the Stress Out of Business & Bookkeeping—So You Can Focus
                on What Matters Most.
              </h1>
              <p className="text-lg text-white/75 mb-8 leading-relaxed">
                Mom-owned virtual bookkeeping and administrative services
        ...
        <div className="max-w-6xl mx-auto px-5 sm:px-8 py-10">
          <div className="text-center max-w-2xl mx-auto">
            ...
            <p className="text-lg text-stone-900 leading-relaxed">
              ...
              small business owners stay organized, compliant, and confident in
              their finances.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-5 sm:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            ...
            <div className="border border-stone-200 rounded-2xl p-7 shadow-2xl hover:border-[#266b75]/30 transition-all">
              ...
              <p className="text-m text-stone-700 mb-4">
                Admin support that keeps you moving.
              </p>
              <ul className="space-y-2">
                {[
              ...
              <ul className="space-y-3">
                {WHY_US.map((item) => (
                  ...
                  >
                    ...
                    <span className="text-m">{item}</span>
                  </li>
                ))}
              </ul>
              <Link
                href="/about"
                className="mt-7 inline-flex items-center gap-2 text-sm font-semibold text-white bg-[#266b75] px-5 py-2.5 rounded-xl hover:bg-[#1f5560] transition-colors shadow-2"
              >
                Learn My Story <ArrowRight className="w-4 h-4" />
              </Link>
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-[#266b75] rounded-2xl p-7 text-center text-white shadow-2xl">
                <p className="text-[2.7rem] font-bold mb-1">6+</p>
                <p className="text-white/70 text-xs font-medium uppercase tracking-wide">
                  Years Experience
                </p>
              </div>
              <div className="bg-white border border-stone-200 rounded-2xl p-7 text-center shadow-2xl">
              ...
              <div className="bg-[#7dbdc6]/20 border border-[#7dbdc6]/30 rounded-2xl p-7 text-center shadow-2xl">
                <p className="text-[2.7rem] font-bold text-[#266b75] mb-1">
                  24h
                </p>
                <p className="text-stone-900 text-xs font-medium uppercase tracking-wide">
                  Response Time
                </p>
              </div>
            </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-5 sm:px-8">
          ...
          <div className="text-center mt-10 flex flex-wrap justify-center gap-3">
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#266b75] text-white font-semibold rounded-xl hover:bg-[#1f5560] transition-colors shadow-sm text-sm"
            >
              Book A Call!
            </Link>
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 px-5 py-2.5 border border-[#266b75] text-[#266b75] font-semibold rounded-xl hover:bg-[#266b75]/5 transition-colors text-sm"
            >
              Contact Me!
            </Link>
          </div>
