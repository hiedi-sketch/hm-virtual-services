          ...
          <div className="flex flex-col md:flex-row items-center gap-10 md:gap-16">
            ...
            <div className="flex-1">
              ...
              <p className="text-white text-lg leading-relaxed mb-8">
                Virtual assistant services that handle your day-to-day
                operations — so you can show up fully for the work only you can
                do.
              </p>
              <Link
                href="/contact"
      ...
      <section className="py-16 bg-white">
        <div className="max-w-8xl mx-auto px-10 sm:px-12 py-16">
          ...
          <p className="text-stone-700 text-center text-m mb-10">
            Reliable virtual assistant support across every area of your
            business.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {SERVICES.map(({ icon: Icon, title, desc, items }) => (
              <div
                key={title}
                className="bg-white border border-stone-200 rounded-2xl p-6 shadow-2xl hover:border-[#266b75]/30 transition-all"
              >
